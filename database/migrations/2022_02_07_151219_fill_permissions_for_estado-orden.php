...
class FillPermissionsForEstadoOrden extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForEstadoOrden constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.estado-orden',
            'admin.estado-orden.index',
            'admin.estado-orden.create',
            'admin.estado-orden.show',
            'admin.estado-orden.edit',
            'admin.estado-orden.delete',
            'admin.estado-orden.bulk-delete',
        ]);
